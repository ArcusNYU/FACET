...
import trainer  # re-exports trainer.{config,setup,optim,loss,loader,logger,ckpt,valid}
...
def prepare_batch(raw_model, batch, cfg, device, dtype):
    ...
    # b. ref branch: [B,3,H,W] VAE-encode to single-frame latents. (encode moves to device)
